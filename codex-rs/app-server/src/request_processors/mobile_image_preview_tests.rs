...
#[test]
fn resizes_highly_compressible_generated_image_result() {
    let image = ImageBuffer::from_pixel(1024, 1024, Rgba([0, 0, 0, 0]));
    ...
    assert_eq!((preview.width(), preview.height()), (192, 192));
}
